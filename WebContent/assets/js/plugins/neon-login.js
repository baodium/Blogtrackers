...
;(function($, window, undefined)
{
	...
	$(document).ready(function()
	{
		...
		console.log(neonLogin.$container);
		...
		neonLogin.$container.validate({
			...
			console.log("submitted");	
				...
				*/
				...
				$(".login-form").addClass('logging-in'); // This will hide the login form and init the progress bar
					...
					$.ajax({
						...
						success: function(response)
						{
							...
							setTimeout(function()
							{
								...
								{
									$(".login-form").removeClass('logging-in');
									neonLogin.resetProgressBar(true);
								}else if(login_status != 'success'){
									$(".login-form").removeClass('logging-in');									
									$("#error_message-box").html('Sorry, you cannot login, your account has been marked as "'+login_status+'"');
									neonLogin.resetProgressBar(true);
								}else if(login_status == 'success'){
