...
<!--					    		<small class="display-block">Network engineer</small>-->
				    			...
				    			<ul class="icons-list mt-15">
			                    	<li><a href="#" data-popup="tooltip" title="" data-container="body" data-original-title="Keyword Trends">
...
<!--					    		<small class="display-block">Network engineer</small>-->
				    			...
				    			<ul class="icons-list mt-15">
			                    	<li><a href="#" data-popup="tooltip" title="" data-container="body" data-original-title="Sentiments">
...
<!--					    		<small class="display-block">Network engineer</small>-->
				    			...
				    			<ul class="icons-list mt-15">
			                    	<li><a href="#" data-popup="tooltip" title="" data-container="body" data-original-title="Influence">
			                    	<button type="button" class="btn btn-primary btn-icon btn-float btn-float-lg btn-rounded legitRipple"><i class="icon-newspaper"></i></button>
			                    	</a></li>
...
<!--					    		<small class="display-block">Network engineer</small>-->
				    			...
				    			<ul class="icons-list mt-15">
			                    	<li><a href="#" data-popup="tooltip" title="" data-container="body" data-original-title="Data Presentation">
			                    	<button type="button" class="btn btn-primary btn-icon btn-float btn-float-lg btn-rounded legitRipple"><i class="icon-file-spreadsheet"></i></button>
			                    	</a></li>
