...
<script type="text/javascript" src="assets/js/pages/datatables_basic.js"></script>
	...
	<script type="text/javascript" src="assets/js/plugins/ui/ripple.min.js"></script>
			...
			<script	src="${pageContext.request.contextPath}/vendors/jQCloud-master/jqcloud/jqcloud-1.0.4.js"></script>
...
window.onload = function() {
	...
	var chart = new CanvasJS.Chart("chartContainer", {
		...
		data : [ {
			click : function(e) {
			alert(e.dataPoint.x + " " + e.dataSeries.name);
			},
			...
			color : "#0000ff",
			showInLegend : true,
			// problem with code here code base from backend
			name : tabData[3].bloggerName,
			dataPoints : f5
		} ],
		legend : {
