...
<br/><br/>
                ...
                <ul class="nav side-menu">
                  ...
                  <ul class="nav side-menu">
                   <li><a href="<%=request.getContextPath()%>/KeywordTrendsServlet"><i class="fa fa-key"></i>Keyword Trends<span class="fa fa-chevron-right"></span></a>
                  </li>
                  </ul>
                  <ul class="nav side-menu">
                   <li><a href="<%=request.getContextPath()%>/Sentiments"><i class="fa fa-puzzle-piece"></i>Sentiments<span class="fa fa-chevron-right"></span></a>
                  </li>
                  </ul>
                  <ul class="nav side-menu">
