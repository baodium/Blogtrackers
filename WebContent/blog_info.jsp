			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a class="site_title"><img src="production/images/cosmos.jpg"> <span>Blogtrackers</span></a>
					</div>
				...
				<div class="nav_menu">
					<nav>
						...
						<div class="nav toggle" style="position: absolute; right: 35%; width: 30%;">
							<form name="trackerform" id="trackerform" action="AdditionalInfoServlet"
								method="post">
			...
			<div class="right_col" role="main">
				<div class="">
						...
						<div class="form-group">
							<div class="col-md-5 col-sm-4 col-xs-12">
								<div class="col-md-12 col-sm-12 col-xs-12">
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										<form name="sitesform" id="sitesform" action="AdditionalInfoServlet"
											method="post">
											<select id="allsitesid" name="allsitesid" value="${item}"
												...
												<div>
													...
													<c:set var="i" value="0" />
													<c:forEach items="${allSepSites}" var="item" begin="${i}">
														<option value="${item.siteID},${item.siteName}"><c:out
																value="${item.siteName}" /></option>
													</c:forEach>
												</div>
											</select> <br /> <select id="allsitesid_author" name="allsitesid" value="${item}"
												onchange="siteChanged()" class="form-control" required>
												<div>
													<c:choose>
														<c:when test="${bsName != null}">
										...
										<!-- <form action="AdditionalInfoServlet" method="post">
											<div class="nav toggle">
												<input value="Search" id="goButton" name="goButton" type="submit">
											</div>
										</form> -->
									</div>
								</div>
								...
								<div class="col-md-2 col-sm-2 col-xs-12">
									<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											...
											<a href="${siteUrl}" target="_blank" class="btn btn-round btn-primary">Visit
												Blog Site</a>
															...
															<div class="scroll" style="height: 343px;">
																<div class="x_content">
																	<table class="table table-hover">
																		...
																		<tbody>
																			<c:set var="i" value="0" />
																			<c:forEach items="${mostDomains}" var="s2" begin="${i}">
																				<tr>
																					<td scope="row"><a href="${s2.link}" target="_blank">${s2.link}</a></td>
																	...
																	<table class="table table-hover">
																		...
																		<tbody>
																			...
																			<c:forEach items="${mostLinks}" var="s1" begin="${i}">
																				<tr>
																					<td scope="row"><a href="${s1.link}" target="_blank">${s1.link}</a></td>
					...
					<div class="footer_fixed">
						<footer>
							<div class="pull-right" style="height: 6px;">Blogtrackers</div>
							<div class="clearfix"></div>
					...
					<script type="text/javascript">
						...
						function siteChanged(var1, var2) {
							$("#allsitesid_author").removeClass("hidden");
							return false;
