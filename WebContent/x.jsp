			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="index.html" class="site_title"><img src="images/cosmos.jpg"></i>
							<span>Blogtrackers</span></a>
					</div>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li><a href="<%=request.getContextPath()%>/Dashboard"><i
										class="fa fa-home"></i>Home<span class="fa fa-chevron-right"></span></a></li>
							</ul>
							<ul class="nav side-menu">
								<li><a href="${pageContext.request.contextPath}/posting_frequencey.jsp"><i
										class="fa fa-line-chart"></i>Posting Frequencey<span
										class="fa fa-chevron-right"></span></a></li>
							</ul>
							<ul class="nav side-menu">
								<li><a href="${pageContext.request.contextPath}/keyword_trends.jsp"><i
										class="fa fa-key"></i>Keyword Trends<span class="fa fa-chevron-right"></span></a></li>
							</ul>
							<ul class="nav side-menu">
								<li><a
							...
							<ul class="nav side-menu">
								<li><a href="${pageContext.request.contextPath}/topic_models.jsp"><i
										class="fa fa-language"></i>Topic Models<span class="fa fa-chevron-right"></span></a></li>
							</ul>
							<ul class="nav side-menu">
								<li><a href="${pageContext.request.contextPath}/sentiments.jsp"><i
										class="fa fa-puzzle-piece"></i>Sentiments<span class="fa fa-chevron-right"></span></a></li>
							</ul>
							<ul class="nav side-menu">
								<li><a href="${pageContext.request.contextPath}/influence.jsp"><i
										class="fa fa-newspaper-o"></i>Influence<span class="fa fa-chevron-right"></span></a></li>
							</ul>
							<ul class="nav side-menu">
								<li><a href="${pageContext.request.contextPath}/cyber_forensics.jsp"><i
										class="fa fa-code-fork"></i>Cyber Forensics<span
										class="fa fa-chevron-right"></span></a></li>
							</ul>
							<ul class="nav side-menu">
								<li><a><i class="fa fa-desktop"></i> Network Analysis <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath}/blog_network.jsp">Blog
												Network</a></li>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-video-camera"></i> Training <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath}/video.jsp">Video
												Tutorials</a></li>
										<li><a href="${pageContext.request.contextPath}/page_404.jsp">Download
												PDF</a></li>
									</ul></li>
					...
					<div class="sidebar-footer hidden-small">
						...
						</a> <a data-toggle="tooltip" data-placement="top" title="FullScreen"> <span
							...
							<li role="presentation" class="dropdown"><a href="javascript:;"
								...
								<ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
									<li><a> <span class="image"><img src="images/img.jpg"
												alt="Profile Image" /></span> <span> <span>Sender 1</span> <span
												class="time">3 mins ago</span>
										</span> <span class="message"> Message.... </span>
									</a></li>
									<li><a> <span class="image"><img src="images/img.jpg"
												alt="Profile Image" /></span> <span> <span>Sender 2</span> <span
												class="time">20 mins ago</span>
										</span> <span class="message"> Message.... </span>
									</a></li>
									<li><a> <span class="image"><img src="images/img.jpg"
												alt="Profile Image" /></span> <span> <span>Sender 3</span> <span
												class="time">45 mins ago</span>
										</span> <span class="message"> Message.... </span>
									</a></li>
									<li><a> <span class="image"><img src="images/img.jpg"
												alt="Profile Image" /></span> <span> <span>Sender 4</span> <span
												class="time">24 hours ago</span>
										</span> <span class="message"> Message.... </span>
									</a></li>
									<li>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="x_panel">
								<div class="x_title">
									<h3>
										Keyword Tree <small> node-link tree</small>
									</h3>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="dashboard_graph">
							...
							<div class="x_panel">
								<div class="x_title">
									<h3>
										Browser <small> with influence score and sentiment score</small>
									</h3>
