...
public class CountryCodes {
   ...
   public CountryCodes() {
	   ...
	   for(int i=0;i<isoCountries.length;i++)
	   {
		   ...
		   names.put(isoCountries[i], locale.getDisplayCountry());
	   }
   ...
   /*	String[] countries = Locale.getISOCountries();
       ...
       for (String country : countries)
       {
		...
		map.put("Zaire", "ZR");
		map.put("Zimbabwe", "ZW");
		map.put("Belgrade", "RS");  // It's is capitol of Serbia country
	}
...
//		 System.out.println(" country "+country);
		// System.out.println(" country  code"+ localeMap.get(country).toString());
	     ...
	     countryFound = names.get(country).toString();
