...
import blogtracker.util.Sentiments_result;
import blogtracker.util.Sentiments_util;
import blogtracker.util.TrackerDialog;

/**
 * Servlet implementation class Sentiments
 * @author mukti
 */
@WebServlet("/Sentiments")
public class Sentiments extends HttpServlet {
...
//						System.out.println("");
		...
		response.sendRedirect("sentiments.jsp");
	}
}
